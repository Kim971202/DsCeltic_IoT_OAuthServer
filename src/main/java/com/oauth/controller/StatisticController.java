...
public class StatisticController {
    ...
    public HashMap<String, Object> doInfoDaily(HttpServletRequest request, HttpServletResponse response,
            @ModelAttribute AuthServerDTO params)
    ...
    public HashMap<String, Object> doVentilationAirStats(HttpServletRequest request, HttpServletResponse response,
            @ModelAttribute AuthServerDTO params)
            throws CustomException {
    ...
    /* 각방 보일러 사용 통계조회 */
    @RequestMapping("/eachRoomStatInfo")
    public HashMap<String, Object> doEachRoomStatInfo(HttpServletRequest request, HttpServletResponse response,
            @ModelAttribute AuthServerDTO params)
            throws CustomException {

        log.info("[각방 보일러 사용 통계조회]");
        common.logParams(params);
        HashMap<String, Object> result = new HashMap<>();
        if (Validator.isNullOrEmpty(params.getUserId()) ||
                Validator.isNullOrEmpty(params.getDeviceId()) ||
        ...
        return statisticService.doEachRoomStatInfo(params);
    }
